                ...
                N("Olfactores", 545, APPROX,
                  ...
                  N("Vertebrates", 535, APPROX + " (cyclostome/gnathostome split)",
                    ...
                    N("Jawed vertebrates", 458, IRI17,
                      N("Chondrichthyes", 420, APPROX,
                        N("Elasmobranchii", 300, APPROX,
                          N("Selachii", 250, APPROX,
                            N("Galeomorphii", 200, APPROX,
                              N("Carcharhiniformes", 150, APPROX),
                            ),
                          ),
                          N("Batoidea", 200, APPROX),
                        ),
                      ),
