        ...
        N("Cnidaria + Bilateria", 651, STR21,
          ...
          N("Bilateria", 616, STR21,
            N("Protostomes", 592, STR21,
              N("Ecdysozoa", 580, APPROX,
                N("Arthropoda", 550, APPROX + " (cf. Lozano-Fernandez et al. 2016)",
                  N("Chelicerata", 480, APPROX,
                    N("Arachnida", 450, APPROX),
                  ),
                  N("Mandibulata", 540, APPROX,
                    N("Pancrustacea", 510, APPROX,
                      N("Multicrustacea", 500, APPROX,
                        N("Cirripedia", 300, APPROX),
                        N("Malacostraca", 430, APPROX,
                          N("Eumalacostraca", 420, APPROX,
                            N("Eucarida", 410, APPROX,
                              N("Decapoda", 400, APPROX + " (cf. Wolfe et al. 2019)",
                                N("Dendrobranchiata", 250, APPROX),
                                N("Pleocyemata", 380, APPROX,
                                  N("Caridea", 280, APPROX),
                                  N("Reptantia", 350, APPROX,
                                    N("Achelata", 250, APPROX),
                                    N("Astacidea", 260, APPROX),
                                    N("Meiura", 300, APPROX,
                                      N("Anomura", 250, APPROX),
                                      N("Brachyura", 200, APPROX,
                                        N("Eubrachyura", 150, APPROX),
                                      ),
                                    ),
                                  ),
                                ),
