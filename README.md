...
**The demo in this repository runs on the open tree, version `open-0.5`**: all 3,279 listed species, assembled entirely from published, redistributable chronograms grafted onto a backbone of deep-node ages, plus a class- and order-level skeleton for the groups that have no species-level open chronogram. Sources:
...
- [x] Open, redistributable dated tree (v0.4: every listed species placed; nine species-level sources; decapod and bivalve skeletons dated from Wolfe et al. 2019 and Li et al. 2025; other invertebrate, algal and ascomycete skeleton ages under review)
