...
- [x] Open, redistributable dated tree (v0.4: every listed species placed; nine species-level sources; decapod, bivalve and insect-order skeletons dated from Wolfe et al. 2019, Li et al. 2025, Misof et al. 2014, Peters et al. 2017 and Kawahara et al. 2019; other invertebrate, algal and ascomycete skeleton ages under review)
